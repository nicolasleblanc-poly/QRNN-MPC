...
def get_config(len_horizon=30, num_repeat_actions=1, include_time_model=False,):
	observation_config = ObservationConfig(
		obs_var_norm = [1e-6, 1e-6, 1e-6, 1e-6]
	)

	reward_config = RewardConfig(
		target_state_norm=[0.5, 0.5, 0.5, 0.5],

		weight_state=[0.1, 1, 0.1, 0], 
		weight_state_terminal=[1, 10, 1, 0], 
		...
		state_min=[-1000, -1, -1000, -1000], # ToDo
		state_max=[1000, 1, 1000, 1000], # ToDo
		area_multiplier=1, 
	...
	model_config = ModelConfig(
		gp_init = {
            "noise_covar.noise": [1e-5, 1e-5, 1e-5, 1e-5],
            "base_kernel.lengthscale": [0.5, 0.5, 0.5, 0.5],
            "outputscale": [5e-2, 5e-2, 5e-2, 5e-2]
		},
		min_std_noise=1e-3,
		max_std_noise=1e-2,
	...
	memory_config = MemoryConfig(
		...
		min_error_prediction_state_for_memory=[3e-3, 3e-3, 3e-3, 3e-3],
		min_prediction_state_std_for_memory=[3e-3, 3e-3, 3e-3, 3e-3],
