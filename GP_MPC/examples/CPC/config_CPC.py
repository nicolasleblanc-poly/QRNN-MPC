...
def get_config(len_horizon=30, include_time_model=False, num_repeat_actions=1):
	...
	reward_config = RewardConfig(
		...
		weight_state=[0.1, 0.1, 1, 0], 
		weight_state_terminal=[2, 2, 5, 2], 
	...
	model_config = ModelConfig(
		gp_init = {
			"noise_covar.noise": [1e-5, 1e-5, 1e-5, 1e-5], # variance = (std)²
			"base_kernel.lengthscale": [0.5, 0.5, 0.5, 0.5],
			# "base_kernel.lengthscale": [2, 2, 8],
	...
	memory_config = MemoryConfig(
		...
		min_error_prediction_state_for_memory=[3e-4, 3e-4, 3e-4, 3e-4],
