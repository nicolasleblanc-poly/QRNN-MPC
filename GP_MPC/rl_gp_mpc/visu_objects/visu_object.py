...
class ControlVisualizations:
    def __init__(self, env:Env, env_name, num_steps:int, control_config: Config, visu_config: VisuConfig):
        ...
        if env_name == "PandaReach-v3" or env_name == "PandaReachDense-v3":
            self.obs_min = env.observation_space['observation'].low
            self.obs_max = env.observation_space['observation'].high
        else:
