...
class ModelEnv:
    ...
    def __init__(
        ...
        if prob:
            self.prob = prob
            self.observation_space = env.observation_space['observation'].shape
        else:
    ...
    def step(
        ...
        with torch.no_grad():
            ...
            if self.reward_fn is None:
                ...
                if self.prob == "PandaReach" or self.prob == "PandaReachDense":
                    rewards = self.reward_fn(actions, next_observs, self.goal_state)
                else:
            ...
            return next_observs, rewards, next_model_state # dones
    ...
    def evaluate_action_sequences(
        ...
        with torch.no_grad():
            ...
            for time_step in range(horizon):
                ...
                _, rewards, model_state = self.step( # dones
