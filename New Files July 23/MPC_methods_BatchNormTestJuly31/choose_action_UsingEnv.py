...
from mpc_UsingEnv import mpc_UsingEnv_func
from particle_filtering import particle_filtering_func, discrete_cem_func, continuous_cem_func

def choose_action_func_UsingEnv(prob_vars, state, particles, do_RS, use_ASGNN, model_ASN, episode=0, step=1, goal_state=None):
    ...
    for rep in range(nb_reps):
        ...
        costs = mpc_UsingEnv_func(prob_vars, sim_states, particles, use_ASGNN, model_ASN)
