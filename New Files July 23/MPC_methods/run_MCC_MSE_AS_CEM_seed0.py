...
from ASNN import ReplayBuffer_ASNN, ASNN, gaussian_nll_loss, categorical_cross_entropy_loss, train_ASNN
...
method_name = "MPC_MSENN_ASNN_mid_ChangeHorizonTo30From12_AddedVelocity"
use_QRNN = False
use_50NN = False
use_MSENN = True
...
model_ASN = ASNN(prob_vars.state_dim, prob_vars.goal_state_dim, prob_vars.action_dim, discrete=prob_vars.discrete, nb_actions=prob_vars.nb_actions)
...
# method_name = "MPC_MSENN_basic_mid_ChangeHorizonTo30From12_AddedVelocity"
# use_QRNN = False
# use_50NN = False
# use_MSENN = True
