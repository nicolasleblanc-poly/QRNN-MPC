...
def save_data_EvoCEM(prob, method_name, episodic_rep_returns, mean_episodic_returns, std_episodic_returns):
    ...
    np.savez(
    f"{prob}_{method_name}_June2_EvoCEM.npz",
...
if not prob_vars.discrete:
    ...
    save_data_EvoCEM(prob, method_name, episode_rep_rewards_QRNN_MPC_EvoCEM_mid, mean_episode_rep_rewards_QRNN_MPC_EvoCEM_mid, std_episode_rep_rewards_QRNN_MPC_EvoCEM_mid)
    print("episode_rep_rewards_QRNN_MPC_EvoCEM_mid \n")
