...
class SetpointStateRewardMapper(AbstractStateRewardMapper):
	...
	def get_reward(self, state_mu: torch.Tensor, state_var: torch.Tensor, action:torch.Tensor) -> float:
		...
		"""
		# print("state_mu ", state_mu,"\n")
		# print("action ", action,"\n")
		# print("self.config.target_state_action_norm ", self.config.target_state_action_norm,"\n")
		# print("state_mu.shape ", state_mu.shape,"\n")
		# print("action.shape ", action.shape,"\n")
		# print("self.config.target_state_action_norm.shape ", self.config.target_state_action_norm.shape,"\n")
  
		# print("torch.cat((state_mu, action), -1) ", torch.cat((state_mu, action), -1),"\n")
		# print("self.config.target_state_action_norm ", self.config.target_state_action_norm,"\n")
